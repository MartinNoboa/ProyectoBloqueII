    ...
    <div class="p-4 w-50 bg-light container my-5 shadow p-3 mb-5 bg-body rounded">
        ...
        <form action="{{route('register')}}" method="POST">
            ...
            <div class="mb-3 form-group form-outline px-4">
                <label for="name" class="form-label fs-5 px-0">Nombre<span aria-hidden="true" class="required text-danger">*</span></label>
            ...
            <div class="mb-3 form-group form-outline px-4">
                <label for="apellido_paterno" class="form-label fs-5 px-0">Apellido Paterno<span aria-hidden="true" class="required text-danger">*</span></label>
            ...
            <div class="mb-3 form-group form-outline px-4">
                <label for="apellido_materno" class="form-label fs-5 px-0">Apellido Materno<span aria-hidden="true" class="required text-danger">*</span></label>
            ...
            <div class="mb-3 form-group form-outline px-4">
                <label for="phone" class="form-label fs-5 px-0">Telefono<span aria-hidden="true" class="required text-danger">*</span></label>
            ...
            <div class="mb-3 form-group form-outline px-4">
                <label for="birthday" class="form-label fs-5 px-0">Fecha de Nacimiento<span aria-hidden="true" class="required text-danger">*</span></label>
            ...
            <div class="mb-3 form-group form-outline px-4">
                <label for="contratacion" class="form-label fs-5 px-0">Fecha de Contratacion<span aria-hidden="true" class="required text-danger">*</span></label>
