    ...
    <div>
        ...
        <div class="grid-2">
            ...
            <div class="text-center">
                <h3>Visión</h3>
                <br>
                <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-eye"
                    viewBox="0 0 16 16">
                    <path
            ...
            <div class="position-absolute top-50 start-50 translate-middle">
                <table class="text-center">
                    <tr>
                        ...
                        <th><a class="btn btn-outline-primary" href="{{ url('/nosotros')}}" role="button">Ver más</a>
                        </th>
                    </tr>
                </table>
            </div>
